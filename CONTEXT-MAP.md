...
- **Ayu Workflow Extension → Permission System**: Workflow prompts are independent from permission state. Use a user-installed permission system for write authorization and `/ayu` for planning/review/verification prompts.
