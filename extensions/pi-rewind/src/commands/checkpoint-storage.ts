...
import type { CheckpointSelectorSession, SessionListProgress } from "./checkpoint-selector";
...
export async function syncLiveSessionManifest(session: SessionInfo): Promise<void> {
...
export async function buildCheckpointSessions(
  cwd: string,
  scope: "current" | "all",
...
export async function deleteCheckpointStorage(
