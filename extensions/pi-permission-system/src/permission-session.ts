...
export class PermissionSession {
  ...
  resetForNewSession(ctx: ExtensionContext): void {
    this.permissionManager = createPermissionManagerForCwd(this.paths.agentDir, ctx.cwd);
    this.skillEntries = [];
   ...
   */
  reload(): void {
    this.permissionManager = createPermissionManagerForCwd(this.paths.agentDir, this.context?.cwd);
    this.skillEntries = [];
    this.toolsCacheKey = null;
    this.promptCacheKey = null;
  }
