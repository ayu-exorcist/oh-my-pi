...
export interface GateDescriptor {
   ...
   */
  sessionApproval?: { surface: string; pattern: string } | { surface: string; patterns: string[] };
...
export interface GateRunnerDeps {
  ...
  canConfirm(): boolean;
  promptPermission(details: PromptPermissionDetails): Promise<PermissionPromptDecision>;
}
