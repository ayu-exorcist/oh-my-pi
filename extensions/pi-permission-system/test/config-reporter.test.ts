...
test("buildResolvedConfigLogEntry includes policy paths and legacy detection flags", () => {
  const policyPaths: ResolvedPolicyPaths = {
    globalConfigPath: "/home/user/.pi/agent/ayu/extensions/pi-permission-system/config.json",
    globalConfigExists: true,
    projectConfigPath: "/projects/my-app/.pi/ayu/extensions/pi-permission-system/config.json",
    projectConfigExists: false,
    agentsDir: "/home/user/.pi/agent/ayu/agents",
    agentsDirExists: true,
    projectAgentsDir: "/projects/my-app/.pi/ayu/agents",
  ...
  expect(result.projectConfigPath).toBe(
    "/projects/my-app/.pi/ayu/extensions/pi-permission-system/config.json",
  );
  expect(result.projectConfigExists).toBe(false);
  expect(result.agentsDir).toBe("/home/user/.pi/agent/ayu/agents");
  expect(result.agentsDirExists).toBe(true);
  expect(result.projectAgentsDir).toBe("/projects/my-app/.pi/ayu/agents");
